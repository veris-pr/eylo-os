...
class RerankingConfigCreate(EyloBaseApiSchema):
...
class RerankingConfigVerificationResponse(EyloBaseApiSchema):
    model_config = ConfigDict(extra="forbid")
...
class RerankingConfigResponse(EyloBaseApiSchema):
    model_config = ConfigDict(extra="forbid")
