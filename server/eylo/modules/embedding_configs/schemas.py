...
class EmbeddingConfigCreate(EyloBaseApiSchema):
...
class EmbeddingConfigVerificationResponse(EyloBaseApiSchema):
    model_config = ConfigDict(extra="forbid")
...
class EmbeddingConfigResponse(EyloBaseApiSchema):
    model_config = ConfigDict(extra="forbid")
