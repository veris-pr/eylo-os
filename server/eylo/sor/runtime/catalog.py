...
VENDOR_CANDIDATES = (
    SorVendorCandidate(
        ...
        description="CRM contacts, companies, deals, their associations, and custom properties.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2,),
        setup_notes=(
    ...
    SorVendorCandidate(
        ...
        description="CRM records, activity, metadata, and custom objects.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2,),
        requires_instance_origin=True,
    ),
    SorVendorCandidate(
        profile=SorProfile.CRM,
        vendor_key="dataverse",
        display_name="Microsoft Dataverse",
        description="Dynamics CRM tables, activities, metadata, and custom tables.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2,),
        requires_instance_origin=True,
    ),
    SorVendorCandidate(
        ...
        description="Projects, issues, workflows, comments, and custom fields.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2, ConnectionAuthKind.BASIC),
        requires_instance_origin=True,
        setup_notes=(
    ...
    SorVendorCandidate(
        ...
        vendor_key="linear",
        display_name="Linear",
        description="Teams, issues, projects, cycles, comments, and labels.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2, ConnectionAuthKind.API_KEY),
        setup_notes=(
    ...
    SorVendorCandidate(
        ...
        description="Repositories, issues, comments, labels, and milestones.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2,),
        setup_notes=(
    ...
    SorVendorCandidate(
        ...
        description="Tickets, customers, comments, groups, fields, and metrics.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2, ConnectionAuthKind.API_KEY),
        requires_instance_origin=True,
        setup_notes=(
    ...
    SorVendorCandidate(
        ...
        description="Conversations, contacts, admins, teams, messages, tags, and attachments.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2,),
        requires_instance_origin=True,
        setup_notes=(
    ...
    SorVendorCandidate(
        ...
        description="Tickets, conversations, contacts, companies, and groups.",
        planned_auth_kinds=(ConnectionAuthKind.API_KEY,),
        requires_instance_origin=True,
    ),
    SorVendorCandidate(
        profile=SorProfile.KNOWLEDGE,
        ...
        description="Spaces, pages, versions, labels, properties, and attachments.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2,),
        requires_instance_origin=True,
        setup_notes=(
            "Create an Atlassian OAuth 2.0 (3LO) app and register the exact Eylo callback URL shown below.",
    ...
    SorVendorCandidate(
        ...
        vendor_key="notion",
        display_name="Notion",
        description="Pages, blocks, data sources, properties, and comments.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2,),
        setup_notes=(
    ...
    SorVendorCandidate(
        profile=SorProfile.KNOWLEDGE,
        vendor_key="linear",
        display_name="Linear Documents",
        description="Current Markdown documents and their authors from Linear.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2,),
        setup_notes=(
    ...
    SorVendorCandidate(
        profile=SorProfile.KNOWLEDGE,
        vendor_key="sharepoint",
        display_name="SharePoint",
        description="Sites, lists, document libraries, pages, and custom columns.",
        planned_auth_kinds=(ConnectionAuthKind.OAUTH2,),
    ),
)
