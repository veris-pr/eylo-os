"""Shared operator-facing AWS configuration choices."""

__all__ = ["AWS_REGION_OPTIONS"]

# Source: https://docs.aws.amazon.com/global-infrastructure/latest/regions/aws-regions.html
# AWS GovCloud and China use separate account partitions; allow_custom on the
# consuming field keeps those partitions and newly launched Regions usable.
AWS_REGION_OPTIONS: tuple[tuple[str, str], ...] = (
    ...
    ("ap-southeast-6", "Asia Pacific (New Zealand) · ap-southeast-6"),
