...
from eylo.modules.integrations_v2.schemas.websocket import WsAuthorizationRequired
from eylo.pipelines.websocket.schemas import WsEventAction

logger = logging.getLogger(__name__)


async def broadcast_auth_required(event: AuthRequiredEvent) -> None:
    ...
    if event.contact_id:
        payload = WsAuthorizationRequired(
