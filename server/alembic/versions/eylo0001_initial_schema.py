...
def upgrade() -> None:
    ...
    # SOR shared canonical persistence.
    _create_table(
        "sor_connectors",
    ...
    op.create_index(
        op.f("ix_sor_connectors_profile"),
        "sor_connectors",
        ["profile"],
        unique=False,
    )
    ...
    _create_table(
        ...
        sa.CheckConstraint(
            "(webhook_signing_secret IS NULL AND webhook_signing_secret_revision = 0) OR "
            "(webhook_signing_secret IS NOT NULL AND webhook_signing_secret_revision > 0)",
    ...
    _create_table(
        ...
        sa.Column(
            "scan_complete", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column("started_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("finished_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("safe_error_code", sa.String(length=128), nullable=True),
    ...
    op.create_index(
        ...
        [
            ...
            "profile",
            "canonical_entity_kind",
            sa.text("projected_at DESC NULLS LAST"),
            sa.text("id DESC"),
        ],
        unique=False,
    ...
    _create_table(
        ...
        sa.CheckConstraint(
            "canonical_entity_kind = 'company'",
            name="ck_sor_crm_companies_entity_kind",
        ),
    ...
    _create_table(
        ...
        sa.CheckConstraint(
            "canonical_entity_kind = 'contact'",
            name="ck_sor_crm_contacts_entity_kind",
        ),
    ...
    _create_table(
        ...
        sa.CheckConstraint(
            "canonical_entity_kind = 'deal'",
            name="ck_sor_crm_deals_entity_kind",
        ),
    ...
    op.create_index(
        op.f("ix_sor_crm_deals_record_id"),
        "sor_crm_deals",
        ["record_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_sor_crm_deals_source_id"),
        "sor_crm_deals",
        ["source_id"],
        unique=False,
    )
    ...
    _create_table(
        ...
        sa.CheckConstraint(
            ...
            name="ck_sor_ticketing_users_entity_kind",
        ),
        sa.CheckConstraint(
    ...
    _create_table(
        ...
        sa.CheckConstraint(
            "profile = 'ticketing'",
            name="ck_sor_ticketing_workflow_states_profile",
        ),
        sa.ForeignKeyConstraint(
            ["organization_id"], ["organization_organizations.id"], ondelete="RESTRICT"
        ),
    ...
    _create_table(
        ...
        sa.CheckConstraint(
            "profile = 'ticketing'",
            name="ck_sor_ticketing_issue_relations_profile",
        ),
        sa.CheckConstraint(
        ...
        sa.UniqueConstraint(
            "record_id",
            name="uq_sor_ticketing_issue_relations_record_id",
        ),
    )
    op.create_index(
    ...
    # SOR Support canonical projections.
    _create_table(
        "sor_support_agents",
        sa.Column("name", sa.Text(), nullable=False),
        sa.Column("primary_email", sa.String(length=1024), nullable=True),
    ...
    # SOR Knowledge canonical projections.
    op.create_table(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_unq_sor_ticketing_users_ext_id_org_id",
        table_name="sor_ticketing_users",
    )
    op.drop_index(
        "ix_sor_ticketing_users_source_name",
        table_name="sor_ticketing_users",
    ...
    op.drop_index(
        "ix_unq_sor_custom_datasets_ext_id_org_id",
        table_name="sor_custom_datasets",
    )
    op.drop_index(
        op.f("ix_sor_custom_datasets_source_id"),
        table_name="sor_custom_datasets",
