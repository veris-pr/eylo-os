...
export interface components {
    schemas: {
         ...
         * @description Stable relationship meanings shared across SOR profiles.
         * @enum {string}
         */
        SorCanonicalRelationKind: "ACTIVITY_FOR_COMPANY" | "ACTIVITY_FOR_DEAL" | "ACTIVITY_WITH_CONTACT" | "ASSIGNED_TO" | "ATTACHED_TO" | "ATTACHED_TO_MESSAGE" | "AUTHORED_BY" | "BELONGS_TO_PROJECT" | "BELONGS_TO_TEAM" | "BLOCKED_BY" | "BLOCKS" | "CHILD" | "COMMENT_ON" | "DUPLICATE" | "FOR_COMPANY" | "HAS_CONTACT" | "HAS_LABEL" | "HAS_TAG" | "IN_CYCLE" | "IN_INBOX" | "IN_QUEUE" | "IN_SPACE" | "MEASURES" | "MESSAGE_IN" | "PARENT" | "PART_OF_DOCUMENT" | "PROPERTY_OF" | "RELATED" | "REPORTED_BY" | "REQUESTED_BY" | "SCOPED_TO_PROJECT" | "VERSION_OF";
        /** SorCatalogResponse */
        SorCatalogResponse: {
            /** Profiles */
        ...
        SorRecordRelationResponse: {
            kind: components["schemas"]["SorCanonicalRelationKind"];
            role: components["schemas"]["SorRelationshipRole"];
            /** Vendor Kind */
            vendor_kind: string | null;
            direction: components["schemas"]["SorRelationshipDirection"];
            /**
             * Record Id
             * Format: uuid
             */
         ...
         * @description Direction of an edge relative to the record being viewed.
         * @enum {string}
         */
        SorRelationshipDirection: "outgoing" | "incoming";
        /**
