...
| Documents | Confluence Cloud | Implemented; live acceptance pending | OAuth 2.0 | spaces, pages, page bodies, versions, properties, attachments | full reconciliation; loss-aware HTML normalization; version reads; mapped create/update/append |
