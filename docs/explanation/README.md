...
These pages explain the design choices connecting Eylo's modules.
...
- [Data ownership and deletion](data-ownership.md)

Use the [reference section](../reference/README.md) for exact current catalogs
and the [how-to section](../how-to/README.md) for procedures.
