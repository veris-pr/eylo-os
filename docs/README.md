...
This tree contains current product and platform documentation only. Roadmaps,
implementation plans, progress boards, review findings, and QA logs belong in
the work system that owns them, not in the published documentation. Current
limitations remain documented when they affect an operator, integrator, or
maintainer contract.
...
open-source implementation; catalog visibility alone is not a runtime contract.
